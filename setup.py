...
#
# However, when we do this, we also import `btsprice/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'btsprice = btsprice.main:entry_point'
        ],
    }
)
